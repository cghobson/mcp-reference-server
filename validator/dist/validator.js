...
export class OnxValidator {
    ...
    transportType;
    options;
    constructor(transport, transportType, options) {
     ...
     */
    static forStdio(config, options = {}) {
    ...
    async validate() {
        ...
        try {
            ...
            // Generate report
            const report = reportGenerator.generate(serverInfo, toolResults, functionalResults, this.transportType);
            return report;
        }
        finally {
            // Always disconnect
